...
def compress_dataset(dataset_path, compressed_dataset_path):
    ...
    Arguments:
        ...
        compressed_dataset_path: The desired path to the compressed dataset. The directory
                                 will be created if it does not currently exist.
    """
